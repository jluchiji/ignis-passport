...
function auth(ignis) {
  ...
  ignis.root.use(_bodyParser2['default'].json());
  ignis.root.use(_passport2['default'].initialize());

  /* Authentication mechanisms */
  ignis.auth.jwt = (0, _strategy2['default'])(JWT.Strategy);
  ignis.auth.local = (0, _strategy2['default'])(Local.Strategy);
}
